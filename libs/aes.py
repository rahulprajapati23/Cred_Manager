...
class AES:
    ...
    def _mix_columns(self, s):
        for i in range(4):
            self._mix_column(s[i])

    def _inv_mix_columns(self, s):
        for i in range(4):
            self._inv_mix_column(s[i])
...
def encrypt_cbc(data, key, iv):
    ...
    for i in range(0, len(data), 16):
        ...
        enc_block = aes.encrypt_block(xor_block)
